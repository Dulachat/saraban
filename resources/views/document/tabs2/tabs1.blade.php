                ...
                <table class="yajra-datatable">
                    ...
                    <tbody class="">
                        ...
                        {{-- @foreach ($documentJoin as $rows)
                            <tr>
                                <th class="text-md">{{ $docs_all->firstItem() + $loop->index }}</th>
                            ...
                            <form action="" method="post" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group mt--3">
                                            <input type="text" class="form-control"
                                                value="{{ $rows->docs_name }}" placeholder="ชื่อเรื่อง">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group mt--3">
                                    ...
                                    <div class="col-md-12 mt--2">
                                        <div class="form-group">
                                            <textarea class="form-control" id="exampleFormControlTextarea1" placeholder="{{ $rows->docs_detail }}"
                                                rows="3" name="docs_detail"></textarea>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group mt--3">
